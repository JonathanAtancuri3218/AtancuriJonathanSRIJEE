...
a persistence unit "AtancuriJonathanSRIJEEPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "AtancuriJonathanSRIJEE\pom.xml":
...
artifact ("AtancuriJonathanSRIJEE.war") is already built. You can build
